...
export class ResourceDescriptor extends $sisyphus.Message<ResourceDescriptor> implements IResourceDescriptor {
    type!: string
    pattern!: readonly string[]
    nameField!: string
    history!: ResourceDescriptor.History
...
$reflection.root.lookupType(".google.api.ResourceDescriptor").messageCtor = ResourceDescriptor
...
export class ResourceReference extends $sisyphus.Message<ResourceReference> implements IResourceReference {
    type!: string
    childType!: string
}
$reflection.root.lookupType(".google.api.ResourceReference").messageCtor = ResourceReference
